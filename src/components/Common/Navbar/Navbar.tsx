          ...
          <div className="px-4 sm:px-6 lg:px-8 rounded-bl-xl bg-white rounded-br-xl shadow-xl py-2">
            <div className="flex h-16 justify-between">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                <div>
                  <div className="relative flexm ml-4 max-w-s items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                    <span className="absolute -inset-1.5" />
