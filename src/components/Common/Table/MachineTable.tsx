    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg px-4 ring-gray-200 ring-1  mt-4">
            <div className="flex justify-between px-4 my-6">
                ...
                <h2 className="text-xs font-semibold  uppercase flex ">Machines</h2>
                <div className={
            ...
            <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8  mt-4">
                <table className="min-w-full ">
                    <thead>
                        <tr>
                            <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-bold text-primary sm:pl-0 cursor-pointer">
                            ...
                            </th>
                            {
                                Object.keys(rowData[0]).map(el => <th scope="col" key={el} className="py-3.5 pl-4 pr-3 text-left text-sm font-bold text-primary sm:pl-0 cursor-pointer "
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        {el === "machine_name" || el === "address" ? (<span className=" hover:text-gray-500 text-primary ml-3 text-xs">
                                            <div>
                                                ▲
                                            </div>
                                            <div>
                            ...
                            <tr key={index}>
                                ...
                                <td className="whitespace-nowrap py-4  pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex items-start gap-x-3">
                                            <p className="text-sm font-medium leading-6 text-gray-900">{el.machine_name.split(" ")[0] + " " + el.machine_name.split(" ")[1] + " " + el.machine_name.split(" ")[2]}  <span className="text-[#B0A6A6]"> {el.machine_name.split(" ")[3]}</span></p>
                                        </div>
                                ...
                                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                                    <div className="flex flex-col">
                                        <div className="flex items-start gap-x-3">
                                            <div className="text-sm font-medium leading-6 text-gray-900">{el.address}</div>
                                        </div>
            ...
            <div >
                <Pagination totalPages={totalPages} currentPage={currentPage} rowPerPage={rowPerPage} setRowPerPage={setRowPerPage}
                    setCurrentPage={setCurrentPage} className="mb-4" /></div>
        </div>
    )
